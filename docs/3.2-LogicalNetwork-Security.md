...
*For this lab, see on top of the page for the VM IP addresses.*  
  <p align="center">
    <img width=85% height=85% src="/docs/assets/Graphics/3.1.2.step4.jpg">
  </p>  
...
Under "Networking - Connectivity - Tier-0 Gateways", edit the "T0-Provider" and under "Routing - Static Routes", set a "Static Route".  
  <p align="center">
    <img width=50% height=50% src="/docs/assets/Graphics/3.2.2.2.step1.jpg">
  </p>  
And Configure the "Set Next Hops" = "20.20.20.1"
  <p align="center">
    <img width=50% height=50% src="/docs/assets/Graphics/3.2.2.2.step2.jpg">
  </p>  
</details>
...
And configure the "BGP Neighbors" = "20.20.20.1", with "Remote AS number" = "2", and with "Source Addresses" = "20.20.20.1".  
  <p align="center">
    <img width=50% height=50% src="/docs/assets/Graphics/3.2.2.3.step2.jpg">
  </p>  
...
And configure the "T1 Connected Interfaces & Segments".  
  <p align="center">
    <img width=50% height=50% src="/docs/assets/Graphics/3.2.2.3.step4.jpg">
  </p>  
...
<p align="center">
  <img width=85% height=85% src="/docs/assets/Graphics/3.2.4.LogicalView.jpg">
</p>  
...
| + Group-Tenant2            |                     |                     |                     |             |          |                     |        |
|                            | Cross-Tenants Allow |    Group-Tenant1    |    Group-Tenant2    |    HTTP     |   None   |         DFW         | Allow  |
|                            | Cross-Tenants Allow |    Group-Tenant2    |    Group-Tenant1    |    HTTP     |   None   |         DFW         | Allow  |
|                            | Cross-Tenants Deny  |    Group-Tenant1    |    Group-Tenant2    |     Any     |   None   |         DFW         | Reject |
|                            | Cross-Tenants Deny  |    Group-Tenant2    |    Group-Tenant1    |     Any     |   None   |         DFW         | Reject |
|                            |                     |                     |                     |             |          |                     |        |
| External                   |                     |                     |                     |             |          |                     |        |
...
[***Next Step: 2. Installation of NSX***](/docs/3.3-Operation-Tools.md)
